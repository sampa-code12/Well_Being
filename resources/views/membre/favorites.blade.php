...
<head>
    ...
    <title>{{ config('app.name') }} - Favoris</title>
...
<div class="dashboard-shell">
    <aside class="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="{{ route('membre.favorites') }}"><i class="bi bi-bookmark"></i> Mes favoris</a>
    ...
    <main class="main-panel">
        ...
        <div class="card-soft p-4">
            <p class="text-muted">Vos favoris pourront être gérés ici.</p>
        </div>
    </main>
</div>
    <script>
