...
<head>
    ...
    <title>{{ config('app.name') }} - Modifier le service</title>
...
<div class="dashboard-shell">
    ...
    <main class="main-panel">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="mb-1">Modifier le service</h2>
                <p class="text-muted mb-0">Mettez à jour le titre, la description ou l'image du service.</p>
            </div>
        ...
        <div class="card-soft p-4">
            ...
            <form method="POST" action="{{ route('admin.services.update', $service) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="titre" value="{{ old('titre', $service->titre) }}" class="form-control" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label class="form-label">Changer l'illustration (fichier)</label>
                    <input type="file" name="image" accept="image/*" class="form-control">
                </div>
                <div class="mb-3">
                    <label class="form-label">Ou URL de l'image (optionnel)</label>
                    <input type="text" name="image_url" value="{{ old('image_url', $service->image_url) }}" class="form-control" placeholder="assets/img/services/service-1.jpg">
                </div>
